...
echo "ready to test shadowhand_motor.urdf"
...
echo "ready to test shadowhand_left_motor.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_motor_ellipsoid.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_motor_biotac.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_left_motor_biotac.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_motor_ff_biotac.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_motor_th_ff_rf_ellipsoid.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_motor_btsp.urdf"
read -p "Press [Enter] key "
...
echo "ready to test sr_three_finger_motor.urdf"
read -p "Press [Enter] key "
...
echo "ready to test sr_one_finger_motor.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_muscle.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_edc_muscle.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_left_muscle.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_left_edc_muscle.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_muscle_biotac.urdf"
read -p "Press [Enter] key "
...
echo "ready to test shadowhand_edc_muscle_biotac.urdf"
read -p "Press [Enter] key "
...
echo "ready to test sr_three_finger_edc_muscle_biotac.urdf"
read -p "Press [Enter] key "
